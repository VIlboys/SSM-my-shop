    ...
    <div class="login-box-body">
        ...
        <form action="/login" method="post">
            ...
            <div class="form-group has-feedback">
                <input name="email" type="email" class="form-control"  placeholder="邮箱" value="${email}" required="" autofocus="">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input name="password" type="password" class="form-control"  required="" value="${password}" placeholder="密码">
