            ...
            <div class="kengl_kuang">
                ...
                <form action="/login" method="post">
                    <div class="txt_kuang">
                        ...
                        <div><input id="Kaptcha" name="verification" type="test" class="itxt"  placeholder="验证码" style="width: 120px;">
                        <img id="verificationCode" src="/verification" style="float: right; padding-right: 23px; cursor: pointer;" title="看不起，换一张"/></div>
                    </div>
                    <div class="remember">
                        <div class="fl">
                            <input type="checkbox" >
